...
lab_list = [
    [ '10 days', (30, 5530), -88, (7,7) ],   #10 d
    [ ], # 15 d
    [ ], # 23 d
    [ ], # 1 m
    [ ], # 2 m
    [ ], # 2.6 m
    [ '4 months', (100, 5540), -80 , (-5,-5)], # 4 m
    [ ], # 6.5 m
    [ ], # 9.5 m
    [ '16 months', (100, 5540), -72 , (-5,-5)], # 15 m
    [ '24 months', (100, 5540), -68, (-5,-5) ], # 23 m
    [ '3 years', (300, 5530), -62 , (8,-5)], # 3 y
]
...
#     x, z, delta_pres = add_noflow_ghosts( df_t, [5495, 5595] )
    ...
    if len(l) :
        ...
        labs[0].set_position((x+xoff*nx,y+yoff*ny))
...
for t_bg in reversed(selected_timesteps) :
    ...
    ax.plot(X, P/1e6, ls='--', lw=.6, label=lab, color='k')
    ...
    ax.text(x, y, lab, rotation=rot, color='k',
        ha='left', va='center', fontsize=6,
        bbox=dict(boxstyle='square,pad=0.0', facecolor='white', alpha=0.9, edgecolor='none'))
