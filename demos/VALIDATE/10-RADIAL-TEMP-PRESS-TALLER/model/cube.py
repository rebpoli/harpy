...
gmsh.model.mesh.field.setString( f1, "F", f"{min_size} + ({max_size} - {min_size}) * (F{f_dist}/{dmax})^2" )
...
gmsh.model.mesh.field.setNumber(f4, "VIn", 15)
...
gmsh.model.mesh.field.setNumber(f4, "ZMax", 120 )

fmin = gmsh.model.mesh.field.add("Min")
gmsh.model.mesh.field.setNumbers(fmin, "FieldsList", [f1, f1b, f2, f3, f4])
